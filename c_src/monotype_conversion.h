...
/*! Convert monomer types according to the reaction description of the PolyConversion struct.
...
/*! Fully convert monomer types according to the reaction description of the PolyConversion struct.
  \param p Phase struct describing the simulation
  \return Errorcode
*/
int fully_convert_monotypes(struct Phase *p);

/*! Partially Convert monomer types according to the reaction description of the PolyConversion struct.
