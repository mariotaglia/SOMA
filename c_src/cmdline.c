...
const char *som_args_versiontext =
    "SOMA  Copyright (C) 2016-2021 Ludwig Schneider, Ulrich Welling, "
    "Marcel\nLangenberg, Fabien Leonforte, Juan Orozco and more. This program "
    "comes with\nABSOLUTELY NO WARRANTY; see GNU Lesser General Public License "
    "v3 for details.\nThis is free software, and you are welcome to "
    "redistribute it under certain\nconditions; see GNU Lesser General Public "
    "License v3 for details. \n\n You are using SOMA please cite: \n * "
    "Schneider, Ludwig and Müller, Marcus \n \t \"Multi-Architecture "
    "Monte-Carlo (MC) Simulation of\n \t  Soft Coarse-Grained Polymeric "
    "Materials:\n \t  SOft coarse grained Monte-carlo Acceleration (SOMA)\",\n "
    "   Computer Physics Communications 235C, 463–476 (2019). \n  * Daoulas, "
    "Kostas Ch. and Müller, Marcus , J. Chem.Phys.2006, 125,18";
...
const char *som_args_detailed_help[] = {
    ...
    "  -c, --coord-file=filename     File containing the system description "
    "and all\n                                  Coordinates. (HDF5-Format)",
    "  -t, --timesteps=timesteps     Number of MC sweeps carried out by SOMA.",
    "  -a, --ana-file=filename       File containing the analysis frequency "
    "and is\n                                  going to be appended by the new "
    "measured\n                                  observables. (HDF5-Format)  "
    "(default=`')",
    "  The appending characteristics require, that the user makes sure, that\n "
    " previous data also refers to the same system. Especially in the case "
    "of\n  different grid sizes this can cause issue and maybe no data is "
    "written, if\n  the dimension do not match.",
    "  -g, --gpus=gpus               Number of GPUs per MPI-node to use. The "
    "devices\n                                  0-(gpus-1) are going to be "
    "occupied by SOMA.\n                                  Every node must "
    "feature this number of nodes\n                                  and it is "
    "assumed that the scheduler assignes\n                                  "
    ...
    "  -o, --only-gpu=gpuId          Specify a specific Device for all ranks. "
    "Useful\n                                  for MPI-single rank runs. This "
    ...
    "  -r, --rng-seed=seed           Global seed for the pseudo-random "
    "number\n                                  generator. If you pass seed < "
    ...
    "  -n, --omp-threads=omp_threads Number of omp threads used per MPI rank. "
    "If you\n                                  pass n < 1 it will be set to "
    "1.\n                                  (default=`1')",
    "      --nonexact-area51         Specify to use the exact check of area51. "
    "This\n                                  includes checks, whether a "
    "particle moves\n                                  through a forbidden "
    "area51. Performance might\n                                  be slightly "
    "increased if switched to\n                                  nonexact. "
    "Configuration generation is always\n                                  in "
    "exact mode.  (default=off)",
    "      --move-type=MVT           Specify the Monte-Carlo move type.  "
    "(possible\n                                  values=\"TRIAL\", \"SMART\" "
    "default=`SMART')",
    "      --iteration-alg=ITR-ALG   Specify the iteration algorithm of the "
    "beads.\n                                  This specifies also the level "
    "of parallelism\n                                  that is possible.  "
    "(possible\n                                  values=\"POLYMER\", "
    "\"SET\"\n                                  default=`POLYMER')",
    "      --skip-tests              Skip tests SOMA is usually preforming "
    "before\n                                  and after the simulation to "
    "ensure integrety\n                                  of the data.  "
    "(default=off)",
    "  -l, --load-balance=freq       Frequency of the load balancer. For "
    "homogenous\n                                  architectures this can be "
    "set to high values,\n                                  for hetereogenous "
    "architectures across the\n                                  MPI ranks "
    "small values help to equilibrate\n                                  "
    ...
    "     (default=`10000')",
    "  -d, --N-domains=N             Number of domains for a domain "
    "decomposition.\n                                  (Domain decomposition "
    "is only made linear\n                                  along the X-Axes)  "
    "(default=`1')",
    "      --domain-buffer=N         Number of buffer cells which can contain "
    "ghost\n                                  particles. Experiment and find "
    "the optimum\n                                  for your simulation.  "
    "(default=`20')",
    "      --rcm-update=f            Frequency of the update of the molecule "
    "center\n                                  of mass. If they enter the "
    "ghost layer they\n                                  are sen. Experiment "
    "and find the optimum for\n                                  your "
    "simulation  (default=`100')",
    "      --user=user-args          Additional arguments. The usage of "
    "these\n                                  arguments defined by the user. "
    "The default\n                                  setting ignores the "
    "arguments.",
    ...
    "      --no-sync-signal          Synchronize MPI ranks for correct "
    "signal\n                                  catching. OFF enables "
    "termination via sending\n                                  SIGINT or "
    "SIGTERM to SOMA if the MPI library\n                                  "
    ...
    "     (default=`200')",
    "      --n_random_q=N            Option to determine the number of random "
    "wave\n                                  vectors used for the calculation "
    "of structure\n                                  factor.  (default=`32')",
    "  -f, --final-file=filename     Filename to write the final "
    "configuration.\n                                  (HDF5-Format)  "
    "(default=`end.h5')",
    "      --purpose=description     Describe the purpose of the simulation "
    "run.\n                                  Enables automatic self "
    "documentation. only\n                                  ASCII",
    0};
...
static void clear_given(struct som_args *args_info);
static void clear_args(struct som_args *args_info);
...
static int cmdline_parser_required2(struct som_args *args_info,
                                    const char *prog_name,
                                    const char *additional_error);

const char *cmdline_parser_pseudo_random_number_generator_values[] = {
    "PCG32", "MT", "TT800",
    0}; /*< Possible values for pseudo-random-number-generator. */
const char *cmdline_parser_move_type_values[] = {
    "TRIAL", "SMART", 0}; /*< Possible values for move-type. */
const char *cmdline_parser_iteration_alg_values[] = {
    "POLYMER", "SET", 0}; /*< Possible values for iteration-alg. */
const char *cmdline_parser_set_generation_algorithm_values[] = {
    "SIMPLE", "FIXED-N-SETS",
    0}; /*< Possible values for set-generation-algorithm. */
...
static void clear_args(struct som_args *args_info) {
  ...
  args_info->pseudo_random_number_generator_arg =
      pseudo_random_number_generator_arg_PCG32;
...
static void init_args_info(struct som_args *args_info) {
...
int cmdline_parser_dump(FILE *outfile, struct som_args *args_info) {
  ...
  if (args_info->screen_output_interval_given)
    write_into_file(outfile, "screen-output-interval",
                    args_info->screen_output_interval_orig, 0);
  ...
  if (args_info->pseudo_random_number_generator_given)
    write_into_file(outfile, "pseudo-random-number-generator",
  ...
  if (args_info->move_type_given)
    write_into_file(outfile, "move-type", args_info->move_type_orig,
                    cmdline_parser_move_type_values);
  if (args_info->iteration_alg_given)
    write_into_file(outfile, "iteration-alg", args_info->iteration_alg_orig,
                    cmdline_parser_iteration_alg_values);
  ...
  if (args_info->accepted_load_inbalance_given)
    write_into_file(outfile, "accepted-load-inbalance",
                    args_info->accepted_load_inbalance_orig, 0);
  if (args_info->autotuner_restart_period_given)
    write_into_file(outfile, "autotuner-restart-period",
                    args_info->autotuner_restart_period_orig, 0);
  ...
  if (args_info->set_generation_algorithm_given)
    write_into_file(outfile, "set-generation-algorithm",
  ...
  if (args_info->long_chain_threshold_given)
    write_into_file(outfile, "long-chain-threshold",
                    args_info->long_chain_threshold_orig, 0);
  if (args_info->set_order_frequency_given)
    write_into_file(outfile, "set_order_frequency",
                    args_info->set_order_frequency_orig, 0);
...
int cmdline_parser_ext(int argc, char **argv, struct som_args *args_info,
                       struct cmdline_parser_params *params) {
  int result;
...
int cmdline_parser2(int argc, char **argv, struct som_args *args_info,
...
int cmdline_parser_required2(struct som_args *args_info, const char *prog_name,
                             const char *additional_error) {
...
int cmdline_parser_internal(int argc, char **argv, struct som_args *args_info,
                            struct cmdline_parser_params *params,
                            const char *additional_error) {
  ...
  while (1) {
    ...
    c = getopt_long(argc, argv, "hVc:t:a:g:o:s:r:p:n:l:d:mf:", long_options,
                    &option_index);
    ...
    case 'c': /* File containing the system description and all Coordinates.
                 (HDF5-Format).  */

      if (update_arg((void *)&(args_info->coord_file_arg),
                     &(args_info->coord_file_orig),
                     &(args_info->coord_file_given),
                     &(local_args_info.coord_file_given), optarg, 0, 0,
                     ARG_STRING, check_ambiguity, override, 0, 0, "coord-file",
                     'c', additional_error))
        goto failure;
    ...
    case 't': /* Number of MC sweeps carried out by SOMA..  */
      ...
      if (update_arg(
              (void *)&(args_info->timesteps_arg), &(args_info->timesteps_orig),
              &(args_info->timesteps_given), &(local_args_info.timesteps_given),
              optarg, 0, 0, ARG_INT, check_ambiguity, override, 0, 0,
              "timesteps", 't', additional_error))
        goto failure;

      break;
    case 'a': /* File containing the analysis frequency and is going to be
                 appended by the new measured observables. (HDF5-Format).  */

      if (update_arg((void *)&(args_info->ana_file_arg),
                     &(args_info->ana_file_orig), &(args_info->ana_file_given),
                     &(local_args_info.ana_file_given), optarg, 0, "",
                     ARG_STRING, check_ambiguity, override, 0, 0, "ana-file",
                     'a', additional_error))
        goto failure;

      break;
    case 'g': /* Number of GPUs per MPI-node to use. The devices 0-(gpus-1) are
                 going to be occupied by SOMA. Every node must feature this
                 number of nodes and it is assumed that the scheduler assignes
                 the ranks consequently to the nodes. If set to 0, SOMA tries to
                 run on host-code. Ignored if compiled without OPENACC..  */

      if (update_arg((void *)&(args_info->gpus_arg), &(args_info->gpus_orig),
                     &(args_info->gpus_given), &(local_args_info.gpus_given),
                     optarg, 0, "0", ARG_INT, check_ambiguity, override, 0, 0,
                     "gpus", 'g', additional_error))
        goto failure;

      break;
    case 'o': /* Specify a specific Device for all ranks. Useful for MPI-single
                 rank runs. This option overrides the --gpus option..  */
      ...
      if (update_arg((void *)&(args_info->only_gpu_arg),
                     ...
                     check_ambiguity, override, 0, 0, "only-gpu", 'o',
                     additional_error))
        goto failure;

      break;
    case 's': /* Specify the number of seconds between an output about timings
                 on the screen..  */
      ...
      if (update_arg((void *)&(args_info->screen_output_interval_arg),
                     ...
                     &(local_args_info.screen_output_interval_given), optarg, 0,
                     "10", ARG_DOUBLE, check_ambiguity, override, 0, 0,
                     "screen-output-interval", 's', additional_error))
        goto failure;

      break;
    case 'r': /* Global seed for the pseudo-random number generator. If you pass
                 seed < 0, seed = time(NULL) will be used. Option useful for
                 debuggin purposes..  */

      if (update_arg((void *)&(args_info->rng_seed_arg),
                     &(args_info->rng_seed_orig), &(args_info->rng_seed_given),
                     &(local_args_info.rng_seed_given), optarg, 0, "-1",
                     ARG_INT, check_ambiguity, override, 0, 0, "rng-seed", 'r',
                     additional_error))
        goto failure;
    ...
    case 'p': /* Option to select the pseudo random number generator..  */
      ...
      if (update_arg((void *)&(args_info->pseudo_random_number_generator_arg),
                     ...
                     &(local_args_info.pseudo_random_number_generator_given),
                     optarg,
                     cmdline_parser_pseudo_random_number_generator_values,
                     "PCG32", ARG_ENUM, check_ambiguity, override, 0, 0,
                     "pseudo-random-number-generator", 'p', additional_error))
        goto failure;

      break;
    case 'n': /* Number of omp threads used per MPI rank. If you pass n < 1 it
                 will be set to 1..  */

      if (update_arg((void *)&(args_info->omp_threads_arg),
                     &(args_info->omp_threads_orig),
                     &(args_info->omp_threads_given),
                     &(local_args_info.omp_threads_given), optarg, 0, "1",
                     ARG_INT, check_ambiguity, override, 0, 0, "omp-threads",
                     'n', additional_error))
        goto failure;

      break;
    case 'l': /* Frequency of the load balancer. For homogenous architectures
                 this can be set to high values, for hetereogenous architectures
                 across the MPI ranks small values help to equilibrate faster.
                 Non-MPI runs are uneffected. Values < 0 deactivate the
                 load-balancer..  */

      if (update_arg((void *)&(args_info->load_balance_arg),
                     &(args_info->load_balance_orig),
                     &(args_info->load_balance_given),
                     &(local_args_info.load_balance_given), optarg, 0, "500",
                     ARG_INT, check_ambiguity, override, 0, 0, "load-balance",
                     'l', additional_error))
        goto failure;

      break;
    case 'd': /* Number of domains for a domain decomposition. (Domain
                 decomposition is only made linear along the X-Axes).  */

      if (update_arg(
              (void *)&(args_info->N_domains_arg), &(args_info->N_domains_orig),
              &(args_info->N_domains_given), &(local_args_info.N_domains_given),
              optarg, 0, "1", ARG_INT, check_ambiguity, override, 0, 0,
              "N-domains", 'd', additional_error))
        goto failure;

      break;
    case 'm': /* Specify the bond length used to calculate the energy. This
                 decides, whether the bond length between two particle is
                 calculated as the absolute distance or the minimum image
                 distance..  */

      if (update_arg((void *)&(args_info->bond_minimum_image_convention_flag),
                     0, &(args_info->bond_minimum_image_convention_given),
                     &(local_args_info.bond_minimum_image_convention_given),
                     optarg, 0, 0, ARG_FLAG, check_ambiguity, override, 1, 0,
                     "bond-minimum-image-convention", 'm', additional_error))
        goto failure;
    ...
    case 'f': /* Filename to write the final configuration. (HDF5-Format).  */
      ...
      if (update_arg((void *)&(args_info->final_file_arg),
                     &(args_info->final_file_orig),
                     &(args_info->final_file_given),
                     &(local_args_info.final_file_given), optarg, 0, "end.h5",
                     ARG_STRING, check_ambiguity, override, 0, 0, "final-file",
                     'f', additional_error))
        goto failure;
    ...
    case 0: /* Long option with no short option */
      ...
      /* Specify to use the exact check of area51. This includes checks, whether
       * a particle moves through a forbidden area51. Performance might be
       * slightly increased if switched to nonexact. Configuration generation is
       * always in exact mode..  */
      if (strcmp(long_options[option_index].name, "nonexact-area51") == 0) {

        if (update_arg((void *)&(args_info->nonexact_area51_flag), 0,
                       &(args_info->nonexact_area51_given),
                       &(local_args_info.nonexact_area51_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0,
                       "nonexact-area51", '-', additional_error))
          goto failure;
      ...
      /* Specify the Monte-Carlo move type..  */
        ...
        if (update_arg((void *)&(args_info->move_type_arg),
                       &(args_info->move_type_orig),
                       &(args_info->move_type_given),
                       &(local_args_info.move_type_given), optarg,
                       cmdline_parser_move_type_values, "SMART", ARG_ENUM,
                       check_ambiguity, override, 0, 0, "move-type", '-',
                       additional_error))
          goto failure;

      }
      /* Specify the iteration algorithm of the beads. This specifies also the
         level of parallelism that is possible..  */
      else if (strcmp(long_options[option_index].name, "iteration-alg") == 0) {

        if (update_arg((void *)&(args_info->iteration_alg_arg),
                       &(args_info->iteration_alg_orig),
                       &(args_info->iteration_alg_given),
                       &(local_args_info.iteration_alg_given), optarg,
                       cmdline_parser_iteration_alg_values, "POLYMER", ARG_ENUM,
                       check_ambiguity, override, 0, 0, "iteration-alg", '-',
                       additional_error))
          goto failure;

      }
      /* Skip tests SOMA is usually preforming before and after the simulation
         to ensure integrety of the data..  */
      else if (strcmp(long_options[option_index].name, "skip-tests") == 0) {

        if (update_arg((void *)&(args_info->skip_tests_flag), 0,
                       &(args_info->skip_tests_given),
                       &(local_args_info.skip_tests_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "skip-tests",
                       '-', additional_error))
          goto failure;

      }
      /*  [0,100] Percent of step time which is ignored by load balancer. Low
         values enable better load balancing, but could cause fluctuation of
         polymers..  */
      else if (strcmp(long_options[option_index].name,
                      "accepted-load-inbalance") == 0) {
        ...
        if (update_arg((void *)&(args_info->accepted_load_inbalance_arg),
                       ...
                       &(local_args_info.accepted_load_inbalance_given), optarg,
                       0, "8", ARG_DOUBLE, check_ambiguity, override, 0, 0,
                       "accepted-load-inbalance", '-', additional_error))
          goto failure;

      }
      /* Period in which the autotuner is restarted..  */
      else if (strcmp(long_options[option_index].name,
                      "autotuner-restart-period") == 0) {
        ...
        if (update_arg((void *)&(args_info->autotuner_restart_period_arg),
                       ...
                       &(local_args_info.autotuner_restart_period_given),
                       optarg, 0, "10000", ARG_INT, check_ambiguity, override,
                       0, 0, "autotuner-restart-period", '-', additional_error))
          goto failure;

      }
      /* Number of buffer cells which can contain ghost particles. Experiment
         and find the optimum for your simulation..  */
      else if (strcmp(long_options[option_index].name, "domain-buffer") == 0) {

        if (update_arg((void *)&(args_info->domain_buffer_arg),
                       &(args_info->domain_buffer_orig),
                       &(args_info->domain_buffer_given),
                       &(local_args_info.domain_buffer_given), optarg, 0, "20",
                       ARG_INT, check_ambiguity, override, 0, 0,
                       "domain-buffer", '-', additional_error))
          goto failure;

      }
      /* Frequency of the update of the molecule center of mass. If they enter
         the ghost layer they are sen. Experiment and find the optimum for your
         simulation.  */
      else if (strcmp(long_options[option_index].name, "rcm-update") == 0) {

        if (update_arg((void *)&(args_info->rcm_update_arg),
                       &(args_info->rcm_update_orig),
                       &(args_info->rcm_update_given),
                       &(local_args_info.rcm_update_given), optarg, 0, "100",
                       ARG_INT, check_ambiguity, override, 0, 0, "rcm-update",
                       '-', additional_error))
          goto failure;

      }
      /* Additional arguments. The usage of these arguments defined by the user.
         The default setting ignores the arguments..  */
      else if (strcmp(long_options[option_index].name, "user") == 0) {

        if (update_arg((void *)&(args_info->user_arg), &(args_info->user_orig),
                       &(args_info->user_given), &(local_args_info.user_given),
                       optarg, 0, 0, ARG_STRING, check_ambiguity, override, 0,
                       0, "user", '-', additional_error))
          goto failure;

      }
      /* Option to select the algorithm to generate the indepent sets..  */
      else if (strcmp(long_options[option_index].name,
                      "set-generation-algorithm") == 0) {

        if (update_arg((void *)&(args_info->set_generation_algorithm_arg),
                       &(args_info->set_generation_algorithm_orig),
                       &(args_info->set_generation_algorithm_given),
                       &(local_args_info.set_generation_algorithm_given),
                       optarg, cmdline_parser_set_generation_algorithm_values,
                       "SIMPLE", ARG_ENUM, check_ambiguity, override, 0, 0,
                       "set-generation-algorithm", '-', additional_error))
          goto failure;

      }
      /* Synchronize MPI ranks for correct signal catching. OFF enables
         termination via sending SIGINT or SIGTERM to SOMA if the MPI library
         supports it. ON accerlerates run with many MPI ranks..  */
      else if (strcmp(long_options[option_index].name, "no-sync-signal") == 0) {

        if (update_arg((void *)&(args_info->no_sync_signal_flag), 0,
                       &(args_info->no_sync_signal_given),
                       &(local_args_info.no_sync_signal_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0,
                       "no-sync-signal", '-', additional_error))
          goto failure;

      }
      /* Option to determine the length of the long chain, expressed as the
         inverse fraction of the total bead number..  */
      else if (strcmp(long_options[option_index].name,
                      "long-chain-threshold") == 0) {
        ...
        if (update_arg((void *)&(args_info->long_chain_threshold_arg),
                       ...
                       &(local_args_info.long_chain_threshold_given), optarg, 0,
                       "50", ARG_INT, check_ambiguity, override, 0, 0,
                       "long-chain-threshold", '-', additional_error))
          goto failure;

      }
      /* Option to determine the frequency to check the ordering of the polymers
         which is important for independent_set_iteration..  */
      else if (strcmp(long_options[option_index].name, "set_order_frequency") ==
               0) {
        ...
        if (update_arg((void *)&(args_info->set_order_frequency_arg),
                       ...
                       &(local_args_info.set_order_frequency_given), optarg, 0,
                       "200", ARG_INT, check_ambiguity, override, 0, 0,
                       "set_order_frequency", '-', additional_error))
          goto failure;

      }
      /* Option to determine the number of random wave vectors used for the
        ...
        if (update_arg((void *)&(args_info->n_random_q_arg),
                       &(args_info->n_random_q_orig),
                       &(args_info->n_random_q_given),
                       &(local_args_info.n_random_q_given), optarg, 0, "32",
                       ARG_INT, check_ambiguity, override, 0, 0, "n_random_q",
                       '-', additional_error))
          goto failure;

      }
      /* Describe the purpose of the simulation run. Enables automatic self
         documentation. only ASCII.  */
        ...
        if (update_arg((void *)&(args_info->purpose_arg),
                       ...
                       &(local_args_info.purpose_given), optarg, 0, 0,
                       ARG_STRING, check_ambiguity, override, 0, 0, "purpose",
                       '-', additional_error))
          goto failure;
      }
