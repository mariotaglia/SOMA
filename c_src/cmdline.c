...
void init_args_info(struct som_args *args_info)
{
  ...
  args_info->set_generation_algorithm_help = som_args_detailed_help[25] ;
  args_info->bond_minimum_image_convention_help = som_args_detailed_help[26] ;
  args_info->no_sync_signal_help = som_args_detailed_help[27] ;
  args_info->long_chain_threshold_help = som_args_detailed_help[28] ;
  args_info->set_order_frequency_help = som_args_detailed_help[29] ;
  args_info->n_random_q_help = som_args_detailed_help[30] ;
  args_info->final_file_help = som_args_detailed_help[31] ;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "long-chain-threshold") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->long_chain_threshold_arg), 
                 &(args_info->long_chain_threshold_orig), &(args_info->long_chain_threshold_given),
