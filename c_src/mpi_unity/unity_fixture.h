...
//! change the comm on which the tests are run. Tests will be run on a subset of world, specified by newsize.
//! this call is always collective on MPI_COMM_WORLD, regardless of what ranks are currently part of test world.
//! \param newsize new size of the test-world. 1 <= newsize <= world_size
//! \return 1 if this rank is part of new tests, 0 if not. -1 indicates world is smaller than requested newsize.
