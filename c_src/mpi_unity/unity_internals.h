...
#define UNITY_TEST_ASSERT_APPROX_UINT16_ARRAY_ABS(N, expected, actual, max_dev_elem, max_dev_sum, line)  UnityAssertApproxUint16ArrayAbs(N, expected, actual, max_dev_elem, max_dev_sum, line);
