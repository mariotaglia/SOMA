...
/* imprecise array comparisons */
#define TEST_ASSERT_APPROX_UINT16_ARRAY_ABS(N, expected, actual, max_dev_elem, max_dev_sum)        UNITY_TEST_ASSERT_APPROX_UINT16_ARRAY_ABS(N, expected, actual, max_dev_elem, max_dev_sum, __LINE__)
