...
typedef struct Ana_Info {
    ...
    unsigned int delta_mc_npos_field;       //!<\#mc_sweeps between the ana of the string fields
    unsigned int delta_mc_nneg_field;       //!<\#mc_sweeps between the ana of the string fields
