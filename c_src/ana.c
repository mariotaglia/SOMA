...
/* #pragma omp target enter data map(to:monomer_type_count[0:p->n_types*(p->ana_info.mtf_tested_type_N+1)]) */
...
/* #pragma omp target exit data map(from:monomer_type_count[0:p->n_types*(p->ana_info.mtf_tested_type_N+1)]) */
